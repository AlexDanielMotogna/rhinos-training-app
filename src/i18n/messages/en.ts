export const messagesEN = {
  ...
  'workout.workoutDate': 'Workout Date',
  'workout.actualDuration': 'Actual Workout Duration (minutes)',
  'workout.durationHelper': 'How long did your workout actually take?',
  ...
  'profile.overallTotals': 'Overall Totals',
  'profile.totalWorkouts': 'Total Workouts',
  'profile.totalHours': 'Total Hours',
  'profile.coachWorkouts': 'Coach Plans',
  'profile.freeWorkoutsTotal': 'Free Workouts',

  // Profile - Weekly Metrics
  'profile.thisWeek': 'This Week',
  'profile.lastWeek': 'Last Week',
  'profile.week': 'Week',
  ...
  'attendance.teamSessions': 'Team training sessions created by your coach will appear here.',
  'attendance.defaultAbsent': 'Default status is Absent if no check-in',
  'attendance.checkedIn': 'Checked in successfully',
  'attendance.noUpcomingSessions': 'No team sessions found. Ask your coach to create sessions.',
  ...
  'leaderboard.pointsIntensive': 'Intensive (≥60min)',
  ...
  'drills.generatedBy': 'Generated by Rhinos Training',
  ...
  'notifications.testNotification.body': 'This is a test notification from Rhinos Training',
