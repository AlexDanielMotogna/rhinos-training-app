export const messagesDE = {
  ...
  'spielplan.gamesWon': 'Gewonnene Spiele',
  'spielplan.gamesLost': 'Verlorene Spiele',
  ...
  'workout.workoutDate': 'Trainingsdatum',
  'workout.actualDuration': 'Tatsächliche Trainingsdauer (Minuten)',
  'workout.durationHelper': 'Wie lange hat Ihr Training tatsächlich gedauert?',
